...
export default function ResourcePicker({ initialColor, onPick, children }: ColorPickerProps) {
    ...
    return (
        <>
            ...
            {colorPickerOpen && <div className={styles.colorPickerContainer} style={{ transform: `translateY(${window.innerWidth < 650 ? "-265px" : "-10px"})` }}>
